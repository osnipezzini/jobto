...
using DAL;
using JobTo.ViewModels;
using AutoMapper;
using Microsoft.Extensions.Logging;
using JobTo.Helpers;

namespace JobTo.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        public async Task<string> Email()
        {
            ...
            (bool success, string errorMsg) = await _emailSender.SendEmailAsync(recepientName, recepientEmail, "Test Email from JobTo", message);
